              ...
              <div className="certificate-preview-contents">
                <div className="cerificate-overlayContent">
                  <div className="certificate-Title">
                    {' '}
                    {value.CertificationTitle}certificate Completeio
                  </div>
                  <div className="Certificate-Name">
                    {value.name}deepthi nayak
                  </div>
                  <div className="Certificate-Course">
                    {value.title}ui with illustratin
                  </div>
                  <div className="certificate-Body">
                    <div>
                      {'\u25CF'} Joined:&nbsp;{value.completedDate}20/2/2022{' '}
                      &nbsp;
                    </div>
                    <div>
                      {' '}
                      {'\u25CF'} Completed:&nbsp;20/2/2022 {value.joinedDate}
                      &nbsp;
                    </div>
                    <div className="DifferenceInDays">
                      {'  '}
                      {'\u25CF'}{' '}
                      {date1 && date2 && getDifferenceInDays(date1, date2)}2
                      days
                    </div>
                  </div>
