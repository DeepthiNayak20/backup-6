...
const Upload = () => {
  ...
  const uploadVideosHandler = (e) => {
    ...
    console.log('overview data to be uploaded', overViewDataToBeUploaded)
    alert(JSON.stringify(overViewDataToBeUploaded))
  }
                ...
                <AccordionItemHeading>
                  <AccordionItemButton>
                    <div className="QandA-QuestionContainer">
                      <div className="QandA-QuestionNo">Chapter&nbsp;Name</div>
